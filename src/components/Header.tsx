...
import { Search, Compass, Chrome, Cpu, BookOpen, AlertCircle, GitCompare, Heart } from 'lucide-react';
    ...
    <header className="sticky top-0 z-40 w-full border-b border-[#DADCE0] bg-white/95 backdrop-blur-md">
      <div className="mx-auto flex h-16 max-w-7xl items-center justify-between px-4 sm:px-6 lg:px-8">
        ...
        <div className="flex items-center space-x-2">
          {/* Support Tip Button */}
          <a
            href="https://www.paypal.com/paypalme/officialkchangmai"
            target="_blank"
            rel="noopener noreferrer"
            className="inline-flex items-center space-x-1.5 rounded-full bg-[#FF5E5B] px-3 py-1.5 text-xs font-semibold sm:px-4 sm:py-2 sm:text-sm sm:font-medium text-white hover:bg-[#FF4E4B] transition-all hover:scale-[1.03] active:scale-95 shadow-sm shadow-[#FF5E5B]/20"
